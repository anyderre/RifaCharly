...
public class PrintDemo extends Activity {
    ...
    public boolean CheckUsbPermission(){
		...
		Toast.makeText(getApplicationContext(), getString(R.string.msg_conn_state),Toast.LENGTH_SHORT).show();
    	return false;
    }
		...
		public void onClick(View v) {
			...
			if( v == btn_conn ){
            	...
            	if((lang.compareTo("en")) == 0){	
            		cmd[2] |= 0x10;
            		usbCtrl.sendByte(cmd, dev);    //��������ģʽ
            		usbCtrl.sendMsg("Congratulations!\n", "GBK", dev);
            		cmd[2] &= 0xEF;        
            		usbCtrl.sendByte(cmd, dev);     //ȡ�����ߡ�����ģʽ
	...
	private void printImage() {
    	...
    	for( i = 0 ; i < pg.getLength() ; i++ ){  //ÿ��һ�м��ϰ�ͷ������һ������
    		s = 0;
    		temp[s++] = 0x1D;
    		temp[s++] = 0x76;
    		temp[s++] = 0x30;
